    ...
    <section id="pricing" className="py-24 px-6 relative overflow-hidden">
      <div className="relative max-w-[1600px] mx-auto">
        ...
        <div className="text-center mb-14">
          <p className="text-amber-300 font-semibold text-base uppercase tracking-widest mb-3">{headline}</p>
          <h2 className="text-4xl sm:text-5xl font-black text-amber-300">{subline}</h2>
        </div>
