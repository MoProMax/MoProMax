  ...
  return (
    <div
      ...
      style={{
        ...
        backdropFilter: "blur(18px) saturate(190%) brightness(112%)",
        WebkitBackdropFilter: "blur(18px) saturate(190%) brightness(112%)",
        boxShadow: restShadow,
        transform: "translateY(0) scale(1)",
        transition:
          "transform 0.45s cubic-bezier(0.34,1.56,0.64,1), box-shadow 0.45s ease, background 0.45s ease",
    ...
    >
      ...
      {/* Specular convex glans — boven de content, zoals echt glas */}
      <div
        className="absolute inset-x-0 top-0 pointer-events-none z-10"
        style={{
          height: "60%",
          background:
            "radial-gradient(ellipse 75% 45% at 50% -2%, rgba(255,255,255,0.20) 0%, transparent 72%)",
        }}
      />
    </div>
  );
