...
function useIntersect(rootMargin = "-80px") {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([e]) => { if (e.isIntersecting) { setHit(true); observer.disconnect(); } },
      { rootMargin }
    );
    observer.observe(el);
  ...
  useEffect(() => {
    ...
    const start = setTimeout(() => {
      ...
      const timer = setInterval(() => {
        ...
        if (done) { setValue(to); clearInterval(timer); if (finalValue) setTimeout(() => setLanded(true), 120); }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4">
          <FadeIn delay={0}><div className="text-center">
            ...
            <p className="text-white font-semibold text-base mb-1">Online na eerste gesprek</p>
          ...
          <FadeIn delay={0.1}><div className="text-center">
            ...
            <p className="text-white font-semibold text-base mb-1">Alles inbegrepen vanaf</p>
          ...
          <FadeIn delay={0.2}><div className="text-center">
            ...
            <p className="text-white font-semibold text-base mb-1">Persoonlijke aanpak</p>
          ...
          <FadeIn delay={0.3}><div className="text-center">
            ...
            <p className="text-white font-semibold text-base mb-1">Reactietijd</p>
