            ...
            <div className="p-8">
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button type="submit" className="w-full bg-amber-500 hover:bg-amber-400 text-slate-900 font-black text-lg py-4 rounded-xl transition-all shadow-lg shadow-amber-500/20 hover:-translate-y-0.5">
                    {t.contact.form.send}
                  </button>
                </form>
              )}
