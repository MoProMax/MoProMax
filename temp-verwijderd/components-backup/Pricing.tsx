    ...
    <section id="pricing" className="py-24 px-6 relative overflow-hidden">
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-white">{subline}</h2>
        </div>
              ...
              <tr>
                ...
                {tiers.map((tier) => (
                  <th key={`price-${tier.name}`} className={`px-4 py-5 text-center border-b border-white/[0.06] ${tier.highlight ? "bg-gradient-to-b from-amber-600/15 to-amber-600/5" : "bg-white/[0.02]"}`}>
                    <p className="font-black text-lg text-white mb-1">{tier.name}</p>
                    {tier.isCustom ? (
                      <>
                      ...
                      <p className={`text-4xl font-black mb-4 ${tier.highlight ? "text-amber-400" : "text-white"}`}>
                        {tier.price}
                      </p>
                    )}
