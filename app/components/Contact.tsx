...
export default function Contact() {
  ...
  const inputClass =
    "w-full px-4 py-3 rounded-xl bg-white/[0.09] border border-white/[0.15] text-amber-300 placeholder-amber-700 text-sm focus:outline-none focus:border-amber-400/70 focus:bg-white/[0.14] backdrop-blur-xl transition-all shadow-inner shadow-black/10";
    ...
    <section id="contact" className="py-24 px-6 relative overflow-hidden">
      <div className="relative max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <p className="text-amber-300 font-semibold text-base uppercase tracking-widest mb-4">Contact</p>
            <h2 className="text-4xl sm:text-5xl font-black text-amber-300 mb-6">{t.contact.headline}</h2>
            ...
            <div className="flex items-center gap-3 bg-white/[0.07] backdrop-blur-2xl rounded-xl px-5 py-4 mb-6"
              ...
              <span className="text-amber-300 font-medium text-base">{t.contact.promise}</span>
            </div>
            ...
            <div className="p-8">
              {sent ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-amber-300 font-bold text-lg">{t.contact.form.sent}</p>
                </div>
              ) : (
