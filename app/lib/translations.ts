...
export const translations = {
  en: {
    ...
    automate: {
      ...
      body: "Imagine waking up to five new bookings from yesterday evening. Customers didn't have to call you, didn't have to wait until Monday. They wanted something and sorted it themselves. That's the moment most business owners realize: a website isn't just about being there, it has to work.\n\nBut working means more than just existing. It means when someone lands on your site with a question, that question gets answered. Not by you—you have other things to do. An intelligent assistant on your website does it. Someone asks your hours? Answer. Someone wants to know if you have availability next week? The assistant checks your calendar and tells them. Someone wants to understand what you do? The system explains it, sends the right information, and if they're genuinely interested, brings them to you.\n\nThat personal touch? It actually gets stronger. Because now you only talk to people who are genuinely interested, not everyone who passes by. You communicate purposefully. More efficiently.\n\nSometimes a customer just needs to ask something quickly. Not call, not email—right now, right here. Live chat on your website makes that possible. Someone sees your service, has a question, types it in. You type back. Doubt disappears. Booking happens. That moment where most people drop off—you're there.\n\nFor your regular customers, it's different. They want their own overview. When's my next appointment? Where's my invoice? What have I bought from you? They don't want to call you every time for information you already have. Their own trusted online space gives them that. They log in, see everything they need to see, can update their details, can book something new. You save hours answering questions—and at the same time, you keep them. Because the further customers drift from you, the faster they leave for your competitor. But a customer who's used to managing everything in their own space? That customer feels at home. That customer comes back. That customer talks about you.\n\nNow growth. You've learned that your best customers are actually the ones you already have—they know you, they trust you. So you reach out to them occasionally. Not randomly, but at the right moment. Someone was a customer months ago and went quiet? A warm message reaches them when they're ready to hear it. Someone just bought something? A follow-up email shows them what they didn't know they needed. Automatically. Feels like attention, but you're free from it.\n\nMeanwhile your reviews grow. Not because you ask—you don't ask, you collect. At the moment someone's satisfied, you ask the right way. That moment feels good, so they say yes. Google, Facebook, Trustpilot—your reviews stack up. More reviews, higher in Google, more visibility. A cycle that feeds itself.\n\nSome businesses sell things too. Physical, digital, as subscription, as one-off. Your website sells it all. Not just bookings, but transactions. iDEAL, credit card, Apple Pay—whatever your customers want to use, they can. The website sells all day long. While you're with other customers, you're earning.\n\nAnd all of this—bookings, chatbots, emails, customer spaces, reviews, sales—works together with what you already use. Your accounting software automatically sees which invoices went out. Your calendar syncs with your website so nobody double-books. Your CRM knows who converts well, who you need to call, who you're about to lose. One central system instead of five separate tools where you have to enter the same information over and over.\n\nThat's a website that works. Not beautiful and empty. Beautiful, fast, and working the moment you're not even looking.",
    },
    howItWorks: {
  ...
  nl: {
    ...
    automate: {
      headline: "Jouw website werkt terwijl jij slaapt",
      body: "Het is dinsdagochtend. Je bent net wakker geworden met koffie, je checkt je telefoon en ziet dat er gisteravond vijf afspraken zijn ingeboekt. Via je website. Terwijl jij al sliep. Klanten hebben niet hoeven bellen, niet hoeven wachten tot maandag. Ze wilden iets en hebben het zelf geregeld. Dat is het moment dat veel ondernemers beseffen: een website is niet alleen mooi, het moet werken.\n\nMaar werken betekent meer dan er alleen maar staan. Het betekent dat als iemand op je site landt met een vraag, die vraag beantwoord wordt. Niet door jou — je hebt andere dingen te doen. Een intelligente assistent op je website doet dat. Iemand vraagt hoe laat je open bent? Antwoord. Iemand vraagt of je nog plek hebt volgende week? De assistent checkt je agenda en zegt het. Iemand wil weten wat je precies doet? Het systeem legt het uit, stuurt de juiste informatie door, en als diegene interessant is, brengt het hem bij jou.\n\nTegen de tijd dat iemand bij jou aanklopt, heeft hij al antwoord gekregen, heeft hij al nagedacht, en heeft hij al besloten. Het voorwerk is al gedaan.\n\nSoms wil een klant gewoon iets snel vragen. Niet bellen, niet mailen — meteen, hier en nu. Met live chat op je website is dat mogelijk. Iemand ziet je product, heeft een vraag, tikt het in. Jij tikt terug. Twijfel verdwijnt. Boeking gebeurt. Dat moment waar mensen massaal afvallen — je bent er.\n\nVoor jouw vaste klanten is het anders. Die willen hun eigen overzicht. Wanneer is mijn volgende afspraak? Waar is mijn factuur? Wat heb ik van jou gekocht? Ze willen niet steeds jou moeten bellen voor informatie die je toch al hebt. Een eigen vertrouwde online omgeving geeft ze dat. Ze loggen in, zien alles wat ze moeten zien, kunnen hun gegevens aanpassen, kunnen iets nieuw boeken. Jij bespaart uren aan vragen beantwoorden — en tegelijkertijd houden ze je vast. Want hoe verder klanten bij jou weg zijn, hoe sneller ze weggaan naar de concurrent. Maar een klant die gewend is om in zijn eigen omgeving alles te regelen, die voelt zich thuis. Die komt terug. Die spreekt erover.\n\nJe beste klanten heb je al. Ze kennen je, ze vertrouwen je — en toch verdwijnen ze soms stilletjes. Niet omdat ze ontevreden zijn, maar omdat niemand meer naar ze omkeek. Dus je stuurt ze af en toe iets. Niet zomaar, maar op het juiste moment. Iemand was maanden geleden klant en is stil geworden? Een warm bericht bereikt hem op het moment dat hij daar open voor staat. Iemand heeft net iets gekocht? Een opvolgmail laat hem zien wat hij nog niet wist nodig te hebben. Automatisch. Voelt als aandacht, maar je bent ervan verlost.\n\nTegelijkertijd groeien je reviews. Niet omdat je erom vraagt — je vraagt niet, je verzamelt. Op het moment dat iemand tevreden is, vraag je op de juiste manier. Dat moment voelt goed, dus ze zeggen ja. Google, Facebook, Trustpilot — je reviews stapelen zich op. Meer positieve reviews betekent dat je makkelijker gevonden wordt, waardoor er meer mensen op je site landen, meer reviews achterlaten, en de cyclus zichzelf blijft herhalen en groeien.\n\nSommige bedrijven verkopen ook dingen. Fysiek, digitaal, als abonnement, of eenmalig. Je website doet al dat verkopen. Niet alleen boeken, ook betalen. iDEAL, creditcard, Apple Pay — wat je klanten willen gebruiken, kan. De website verkoopt de hele dag door. Terwijl jij bij andere klanten bent, verdien je geld.\n\nEn dit alles — afspraken, chatbots, e-mails, klantomgeving, reviews, verkopen — werkt samen met wat je al gebruikt. Je boekhoudpakket ziet automatisch welke facturen zijn verstuurd. Je agenda synchroniseert met je website zodat niemand dubbel boekt. Je CRM weet wie goed converteert, wie je moet bellen, wie je bijna verliest. Eén centraal systeem in plaats van vijf aparte tools waar je steeds hetzelfde in moet invoeren.\n\nDat is een website die werkt. Niet mooi en leeg. Mooi, snel, en werkend op het moment dat je niet eens kijkt.",
    },
    howItWorks: {
